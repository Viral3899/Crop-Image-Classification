...
from Crop_Image_Classification.entity.config_entity import \
...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        training_data = os.path.join(
            self.config.data_ingestion.unzip_dir, "Agricultural-crops")
        create_directories([
    ...
    def get_validation_config(self) -> EvaluationConfig:
        ...
        evaluation_config = EvaluationConfig(
            ...
            training_data=Path('artifacts/data_ingestion/Agricultural-crops'),
